                    ...
                    <div className="Player-text-chunk-inner">
                      <div style={{position: 'relative'}}>
                        ...
                        <div className={'Player-text-chunk-annotext Player-text-chunk-annotext-' + (hidden ? 'hidden' : 'visible')}>
                          <AnnoText key={chunk.uid} annoText={chunk.annoText} language={subTrack.language} showRuby={this.props.preferences.showRuby} searchDictionaries={this.props.searchDictionaries} searchKanjiDictionary={this.props.searchKanjiDictionary} ref={(subTrackIdx === 0) ? (c => { this.firstAnnoTextComponent = c; }) : null} />
                        </div>
                      </div>
                    </div>
                  </div>
